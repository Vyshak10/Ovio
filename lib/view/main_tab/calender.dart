...
class _DayHeader extends StatelessWidget {
  ...
  const _DayHeader({required this.day, required this.weekday, Key? key})
      : super(key: key);
...
class _TodayHeader extends StatelessWidget {
  ...
  const _TodayHeader({required this.day, required this.weekday, Key? key})
      : super(key: key);
...
class _PeriodCalendarScreenState extends State<PeriodCalendarScreen> {
  ...
  void _loadMoreMonths(bool loadPrevious) {
    setState(() {
      if (loadPrevious) {
